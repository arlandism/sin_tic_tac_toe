...
describe ButtonPresenter do
  ...
  describe "#render" do
    ...
    blanked_button_template = "<input type='submit', value='%s', name='player_move', disabled>"

    three_button_layout = [ "<input type='submit', value='1', name='player_move'>",
                            "<input type='submit', value='2', name='player_move'>",
                            "<input type='submit', value='3', name='player_move'>"].join("") + "<div></div>"
    ...
    context "given board with non-nil winner" do
      it "outputs board with blanked-out keys" do
        ...
        blanked_buttons = (1..3).each do |n|
          buttons << blanked_button_template % n 
        end 
